...
function generateRandomPoints(count: number) {
    const center = { lng: -1.0232, lat: 7.9465 };
    const features = [];
...
// 100 markers - would be slow with DOM markers, but fast with layers
const pointsData = generateRandomPoints(100);
...
export function LayerMarkersExample() {
    return (
        <div className="h-[800px] w-full">
            <Map center={[-1.0232, 7.9465]} zoom={11}>
                <MarkersLayer />
                <MapControls
